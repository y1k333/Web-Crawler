...
class Parser:
    ...
    @staticmethod
    def parse_gzh(text):
        page = etree.HTML(text) # return the document
        lis = page.xpath('//ul[@class="news-list2"]/li')
        results = []
        for li in lis:
            url = Parser.get_elment(li, 'div/div[1]/a/@href')
    ...
    def parse_urls_from_profile(content):
        ...
        for article in articles['list']:
            ...
            results.append({
                ...
                'content_url': 'https://mp.weixin.qq.com' + Parser._replace_str_html(app_msg_ext_info.get('content_url')),
                ...
                for multi_dict in app_msg_ext_info['multi_app_msg_item_list']:
                    results.append({
                        ...
                        'content_url': 'https://mp.weixin.qq.com' + \
                                       Parser._replace_str_html(multi_dict.get('content_url')),
