...
class SogouRequest:
    ...
    @classmethod
    def generate_article_url(cls, keyword, page,
                                time = SearchArticleTime.ANYTIME, type = SearchArticleType.ALL):
...
if __name__ == '__main__':
    url = SogouRequest.generate_search_GZH_url('123')
    print url